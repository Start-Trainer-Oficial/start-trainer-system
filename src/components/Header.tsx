...
export default function Header() {
  return (
    <div className="flex w-full lg:gap-[25%] justify-center items-center h-20 border-b border-gray-200">
      <Image
  ...
  font-semibold transition-all duration-300 cursor-pointer hover:bg-gradient-to-r from-[#5f2daf] via-[#733df2] to-[#9b4bff] hover:text-white hover:border-transparent">
          Entrar
        </button>
