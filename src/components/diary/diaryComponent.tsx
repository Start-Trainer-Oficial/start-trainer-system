...
export default function DiaryComponent({ title, date, type, status, active }: DiaryComponentsProps) {
    ...
    return (
        <>
            {/* Nav Option */}
            <div className="flex items-center justify-center rounded-xl py-1 bg-gray-700/8 mt-4">
            ...
            <div className="flex flex-wrap justify-center gap-10">
                ...
                <div className="mt-10 w-[390px] border border-gray-700/15 shadow-xs hover:shadow-lg transition-all duration-300 rounded-2xl text-center hover:scale-105 hover:shadow-2xl">
                    ...
                    <div className="flex relative flex-col">
                        ...
                        <button className="w-[350px] self-center mt-5 mb-6 py-2 rounded-xl text-white font-semibold
